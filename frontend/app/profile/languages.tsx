...
export default function Languages() {
  ...
  const handleNext = () => {
    const langs = text
      ...
      .filter((s) => s.length > 0);
    updateProfile({ languages: langs });
    router.push("/profile/culture");
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.questionNumber}>Question 6 of 9: Languages</Text>
      ...
      <View style={styles.card}>
        ...
        <TextInput
          ...
          style={styles.input}
        />
        <Text style={styles.hint}>Separate multiple languages with commas</Text>
